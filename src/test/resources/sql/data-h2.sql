...
VALUES  (X'7e90877fcb284ff0a7960914c3f45e59', 'admin', NOW(), 'admin', NOW(), 'DEFAULT', 'Channel 1 default thumbnail', 100, 100),
        (X'f3e78681b700493c94af25cd95d53848', 'admin', NOW(), 'admin', NOW(), 'MEDIUM', 'Channel 1 medium thumbnail', 200, 200),
        (X'a31aba86d50547e28ca9e71a163958f8', 'admin', NOW(), 'admin', NOW(), 'DEFAULT', 'Channel 2 default thumbnail', 100, 100),
...
# User
INSERT INTO `user`(id, created_by, created_date, modified_by, modified_date, country, date_of_birth, email, gender, password, phone_number, channel_id)
VALUES  (X'3f06af63a93c11e4979700505690773f', 'admin', NOW(), 'admin', NOW(), null, null, 'user@gmail.com', null, '00000000', null, X'a1e6741bfb6d4fb692342a47236bcf16'),
        (X'a05990b1911040b1aa4c03951b0705de', 'admin', NOW(), 'admin', NOW(), null, null, 'user2@gmail.com', null, '00000000', null, X'8c936a6f7fb840078360371e6bafa18f');

# Subscription
INSERT INTO `subscription`(id, created_by, created_date, modified_by, modified_date, published_at, channel_id, user_id)
VALUES  (X'f2cf8a4802d64e04a816045521ee7b83', 'admin', NOW(), 'admin', NOW(), NOW(), X'8c936a6f7fb840078360371e6bafa18f', X'3f06af63a93c11e4979700505690773f'),
        (X'09e5c939889e476aa6947fc400c7f30e', 'admin', NOW(), 'admin', NOW(), NOW(), X'a1e6741bfb6d4fb692342a47236bcf16', X'a05990b1911040b1aa4c03951b0705de');
...
VALUES  ('admin', NOW(), 'admin', NOW(), 0, 0, 0, 2, 0, X'37b32dc2b0e045ab84691ad89a90b978'),
        ('admin', NOW(), 'admin', NOW(), 0, 1, 0, 1, 0, X'f7d9b74b750c4f4983405bcb8450ae14'),
