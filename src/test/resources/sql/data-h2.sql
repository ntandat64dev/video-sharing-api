...
# Channel
INSERT INTO `channel`(id, created_by, created_date, modified_by, modified_date, description, published_at, title, user_id)
VALUES (X'a1e6741bfb6d4fb692342a47236bcf16', 'admin', NOW(), 'admin', NOW(), null, NOW(), 'user1', X'3f06af63a93c11e4979700505690773f'),
       (X'8c936a6f7fb840078360371e6bafa18f', 'admin', NOW(), 'admin', NOW(), null, NOW(), 'user2', X'a05990b1911040b1aa4c03951b0705de');
...
INSERT INTO `video`(id, created_by, created_date, modified_by, modified_date, description, duration_sec, age_restricted, comment_allowed, for_kids,
                    location, title, upload_date, video_url, user_id, visibility_id)
